...
//        holder.summary_tag_recycler_view2.setAdapter(new RecipeTagAdapter(context, recipe.getTags()));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView summary_image1, summary_image2;
        ...
        public ViewHolder(View itemView) {
            ...
            summary_image1 = itemView.findViewById(R.id.summary_image);
            ...
            summary_image2 = itemView.findViewById(R.id.summary_image2);
